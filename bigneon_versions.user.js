...
(function () {
    ...
    setInterval(function () {
        VERSION_DIV.style.backgroundImage = '';
        if (IS_SUPER_ADMIN) {
            VERSION_DIV.className = 'super-admin';
            // VERSION_DIV.style.backgroundImage = SUPERMAN_IMAGE;
            // VERSION_DIV.style.backgroundPosition = 'center center';
            // VERSION_DIV.style.backgroundSize = 'contain';
            // VERSION_DIV.style.backgroundRepeat = 'no-repeat';
        }
